  ...
  <div id="hover">
    ...
    <div id="wrapper">
      ...
      <div id="info">
        ...
        <p> Follow me on <a href="https://dribbble.com/virgilpana" style="color:#ea4c89" target="_blank">Dribbble</a> |
          <a style="color:#2aa9e0" href="https://twitter.com/virgil_pana" target="_blank">Twitter</a></p>
      </div>
      ...
      jQuery(function ($) {
        ...
        $('.product').each(function (i, el) {
          ...
          $(el).find('.view_gallery').click(function () {
            ...
            setTimeout(function () {
              $(el).find('.make3D').removeClass('flip-10').addClass('flip90').find('div.shadow')
              .show().fadeTo(80, 1, function () {
            ...
            setTimeout(function () {
              ...
              setTimeout(function () {
                $(el).find('.make3D').removeClass('flip190').addClass('flip180').find(
                  'div.shadow').hide();
                setTimeout(function () {
