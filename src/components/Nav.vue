<template>
    <div id="nav">
      ...
      <div class='menu'>
        <div class="nav-link">
          <router-link to="/"><div class='menu-item menu-child1'>Home</div></router-link>
          <router-link to="/about"><div class='menu-item'>About</div></router-link>
          <router-link to="/sample"><div class='menu-item'>Sample</div></router-link>
